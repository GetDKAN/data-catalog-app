        ...
        <div className={`dc-page ${config.container}`}>
            ...
            <div className="dc-page-content row mb-5">
                <div class="col-md-9 col-sm-12">
                  ...
                  <p>En definitiva, desde el Ayuntamiento seguimos apostando por iniciativas que faciliten la transparencia de la gestión pública municipal y que sirvan de palancas que fomenten el desarrollo económico y social de nuestra ciudad.</p>
